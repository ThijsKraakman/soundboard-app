  ...
  computed: {
    classes: function classes() {
      if (this.isOwner === false) {
        return ['material-icons align-middle', this.isLiked ? 'text-green-400 hover:text-red-400' : 'text-white hover:text-green-400'];
      } else {
...
var render = function() {
  ...
  return _c("div", [
    _c(
      ...
      {
        class: _vm.classes,
        attrs: { type: "submit", disabled: _vm.isOwner },
        on: { click: _vm.toggle }
      },
      [_vm._v("thumb_up")]
    ),
    _vm._v(" "),
    _c("span", {
      staticClass: "align-bottom ml-2 text-white",
      domProps: { textContent: _vm._s(_vm.likeCount) }
    })
  ])
}
var staticRenderFns = []
